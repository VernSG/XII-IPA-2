    ...
    return (
        <>
        	<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">QURDIS</div>
				...
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">MTK WAJIB</div>
					<div className="flex justify-center items-center text-sm">08.30-10.00</div>
				</div>
				<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="700">
					...
					<div className="flex justify-center items-center text-sm">10.00-10.15</div>
				</div>
				<div className=" border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="800">
					...
					<div className="flex justify-center items-center text-sm">10.15-11.45</div>
				</div>
				...
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60 border-b-2 border-white" data-aos="fade-up" data-aos-duration="900">
					...
					<div className="w-[50%] text-base  font-medium">ISOMA</div>
					<div className="flex justify-center items-center text-sm">12.30-13.15</div>
				</div>
		                <div className=" border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="1100">
					<div className="w-[50%] text-base  font-medium">PKN</div>
					<div className="flex justify-center items-center text-sm">13.15-14.00</div>
				</div>
		                <div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60 border-b-2 border-white" data-aos="fade-up" data-aos-duration="1200">
					<div className="w-[50%] text-base  font-medium">BINDO</div>
					<div className="flex justify-center items-center text-sm">14.00-15.30</div>
				</div>
        </>
    )
} 
