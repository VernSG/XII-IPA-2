				...
				<div class="md:flex md:justify-between">
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="public/logokelasipa2-removebg-preview.png"
								alt=""
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/yusufkartein_/?hl=id" class="hover:underline">
										Yusuf Saputra
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/yusufkartein/?hl=id" class="hover:underline">
										Not Supported
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								...
								<li>
									<a href="https://www.youtube.com/@VernSG" class="hover:underline">
										Youtube
									</a>
								</li>
							</ul>
